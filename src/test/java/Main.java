...
//        ArrayList<Double> list = new ArrayList<>();
        ...
        while (Again.equalsIgnoreCase("y")) {
            ...
            try {ConversionType = converter.nextDouble();}
            catch (InputMismatchException e) { if(ConversionType<1 || ConversionType>2)
                System.out.println("Oh snap! something went wrong...please choose only 1/2");
            }
